...
agent = AgentTBN(csv_path,
                 ...
                 head_number=2,
                 prompt_strategy="coder_only_infilling_functions", # "functions", "simple", "coder_only_simple", "coder_only_functions", "coder_only_infilling_functions"
                 coder_model="gpt-3.5-turbo-1106",
                 # coder_model="codellama/CodeLlama-7b-Instruct-hf",
                 # coder_model="codellama/CodeLlama-7b-Python-hf", # Has no infilling mode
