...
def main(config_path: str = "config.yaml"):
    ...
    def tokenize_function(examples):
        texts = list(map(lambda x,y: "<s>[INST] " + x + " [/INST]\n" + y + "</s>", examples["input"], examples["output"]))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default="finetuning/lora/config/instruct_LoRA_params.yaml", help="Path to the config file.")
