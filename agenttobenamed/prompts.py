...
class Prompts:
    ...
    def generate_code_for_plot_save_prompt(self, df, user_query, plan):
        return self.strategy.format_generate_code_for_plot_save_prompt(self.head_number, df, user_query, plan, self.column_description(df))
